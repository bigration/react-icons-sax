...
const SvgBluetooth = (props: IconProps & SVGProps<SVGSVGElement>) => {
  const mergedStyles = {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="m12.93 10.64 2.33-2.13-2.33-1.87v4Z" fill="currentColor" />
      <path
        ...
        fill="currentColor"
      />
      <path d="m12.93 17.36 2.33-1.95-2.33-2.11v4.06Z" fill="currentColor" />
    </svg>
  );
};
