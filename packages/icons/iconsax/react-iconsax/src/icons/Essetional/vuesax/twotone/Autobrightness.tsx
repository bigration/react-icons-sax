...
const SvgAutobrightness = (props: IconProps & SVGProps<SVGSVGElement>) => {
  const mergedStyles = {
  ...
  return (
    ...
    >
      ...
      />
      <g opacity={0.4} stroke="#292D32" strokeWidth={1.5}>
        <path d="m8.5 15.939 3.5-7.88 3.5 7.88" strokeLinejoin="bevel" />
        <path
