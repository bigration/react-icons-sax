...
const SvgBucketSquare = (props: IconProps & SVGProps<SVGSVGElement>) => {
  const mergedStyles = {
    ...
    >
      ...
      >
        <path
          ...
          strokeMiterlimit={10}
        />
        <path d="M17.3 14.813s-1.31 1.42-1.31 2.29c0 .72.59 1.31 1.31 1.31.72 0 1.31-.59 1.31-1.31-.01-.87-1.31-2.29-1.31-2.29Z" />
      </g>
      <path
