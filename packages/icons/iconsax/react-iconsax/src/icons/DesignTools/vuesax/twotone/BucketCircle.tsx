...
const SvgBucketCircle = (props: IconProps & SVGProps<SVGSVGElement>) => {
  const mergedStyles = {
    ...
    >
      ...
      >
        <path
          ...
          strokeMiterlimit={10}
        />
        <path d="M16.471 14.168s-1.1 1.2-1.1 1.93c0 .61.5 1.1 1.1 1.1.61 0 1.1-.5 1.1-1.1.01-.74-1.1-1.93-1.1-1.93Z" />
      </g>
      <path
