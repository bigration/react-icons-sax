...
const SvgDesigntools = (props: IconProps & SVGProps<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="m20.12 12.73.74.73c1.49 1.49 1.49 2.96 0 4.45l-2.96 2.96c-1.47 1.47-2.96 1.47-4.43 0M3.11 10.51c-1.47-1.49-1.47-2.96 0-4.45L6.07 3.1c1.47-1.47 2.96-1.47 4.43 0l.74.74M11.25 3.85l-3.7 3.7M20.12 12.73l-2.96 2.95"
        stroke="#292D32"
        strokeWidth={1.5}
        strokeLinecap="round"
      />
