...
const SvgMusicLibrary2 = (props: IconProps & SVGProps<SVGSVGElement>) => {
  const mergedStyles = {
  ...
  return (
    ...
    >
      ...
      <g
        ...
        strokeLinejoin="round"
      >
        <path d="M9.07 19.449a1.32 1.32 0 1 0 0-2.64 1.32 1.32 0 0 0 0 2.64Z" />
        <path d="M15.248 17.25v-5.17c0-1.1-.69-1.26-1.39-1.06l-2.65.72c-.48.13-.81.51-.81 1.06v5.33" />
        <path d="M13.93 18.57a1.32 1.32 0 1 0 0-2.64 1.32 1.32 0 0 0 0 2.64ZM10.398 14.347l4.85-1.32" />
      </g>
    </svg>
  );
};
