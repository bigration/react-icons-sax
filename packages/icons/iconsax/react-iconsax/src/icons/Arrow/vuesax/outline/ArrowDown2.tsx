...
const SvgArrowDown2 = (props: IconProps & SVGProps<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M12.001 16.251c-.19 0-.38-.07-.53-.22l-3-3a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l2.47 2.47 2.47-2.47c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-3 3c-.15.15-.34.22-.53.22Z"
        fill="currentColor"
      />
    </svg>
  );
