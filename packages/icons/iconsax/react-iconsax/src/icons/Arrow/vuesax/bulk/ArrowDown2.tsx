...
const SvgArrowDown2 = (props: IconProps & SVGProps<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="m11.468 18.53-4.29-4.29a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l3.01 3.01V6c0-.41.34-.75.75-.75s.75.34.75.75v10.19l3.01-3.01c.29-.29.77-.29 1.06 0 .15.15.22.34.22.53s-.07.38-.22.53l-4.29 4.29a.75.75 0 0 1-1.06 0Z"
        fill="currentColor"
      />
    </svg>
  );
