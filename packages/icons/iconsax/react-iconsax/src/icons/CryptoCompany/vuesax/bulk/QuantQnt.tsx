...
const SvgQuantQnt = (props: IconProps & SVGProps<SVGSVGElement>) => {
  const mergedStyles = {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="#292D32"
      />
      <path d="M7 9.23v5.54L3 17V7l4 2.23Z" fill="#292D32" />
      <path opacity={0.6} d="M12 2v4.44L7 9.22v.01L3 7l9-5Z" fill="#292D32" />
      <path
