...
const SvgBank = (props: IconProps & SVGProps<SVGSVGElement>) => {
  const mergedStyles = {
  ...
  return (
    ...
    >
      ...
      />
      <path opacity={0.6} d="M8 11H4v7h4v-7Z" fill="currentColor" />
      <path opacity={0.4} d="M12 11H8v7h4v-7Z" fill="currentColor" />
      <path opacity={0.6} d="M16 11h-4v7h4v-7Z" fill="currentColor" />
      <path opacity={0.4} d="M20 11h-4v7h4v-7Z" fill="currentColor" />
      <path
