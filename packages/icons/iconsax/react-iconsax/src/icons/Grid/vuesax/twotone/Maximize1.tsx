...
const SvgMaximize1 = (props: IconProps & SVGProps<SVGSVGElement>) => {
  const mergedStyles = {
  ...
  return (
    ...
    >
      ...
      <g
        ...
        strokeLinejoin="round"
      >
        <path d="M18 12v-2M6 12h12H6Zm0 0v-2 2Zm0 0v2-2Zm12 0v2-2ZM12 6h2m-2 12V6v12Zm0 0h2-2Zm0 0h-2 2Zm0-12h-2 2Z" />
      </g>
    </svg>
  );
};
