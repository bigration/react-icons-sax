...
const SvgProgrammingArrows = (props: IconProps & SVGProps<SVGSVGElement>) => {
  const mergedStyles = {
  ...
  return (
    ...
    >
      <path
        ...
        fill="currentColor"
      />
      <path d="M19 22a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" fill="currentColor" />
      <path
        opacity={0.4}
        ...
        fill="currentColor"
      />
      <path d="M5 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" fill="currentColor" />
    </svg>
  );
};
